...
// טקסטים שהם אימוג'י או סימן גרפי בלבד (⚙️, 🔒, ⭐, ✕, ↺) נשארים בפונט
// המערכת בכוונה - Heebo לא מכיל את הגליפים האלה, והשארתם בלי fontFamily
// נותנת לפלטפורמה לבחור את הפונט שכן מכיל אותם.
